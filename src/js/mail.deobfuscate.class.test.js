...
describe('mailDeobfuscate class', () => {
  ...
  it('mailDeobfuscate.replaceString is function', () => {
    let mailDeobfuscate = new MailDeobfuscate()
    expect(typeof mailDeobfuscate.replaceString).toBe('function')
  })

  it('decode "nopqrstuvwxyzabcdefghijklm" to "abcdefghijklmnopqrstuvwxyz"', () => {
    let mailDeobfuscate = new MailDeobfuscate()
